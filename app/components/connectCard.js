  ...
  return (
    <div className="flex flex-row items-center gap-[16px] w-full bg-primary-gray rounded-[16px] p-[12px] md:p-[16px]">
      ...
      <a
        ...
        aria-label={`${cta} on ${name}`}
        className="inline-flex items-center w-fit px-[16px] py-[10px] rounded-[10px] bg-white/10 hover:bg-white/20 hover:cursor-pointer text-white font-dm-sans font-[600] text-[16px] leading-[1.4] ease-in-out duration-[300ms]"
      >
        {cta}
      </a>
    </div>
